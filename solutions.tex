...
%% Make some GWE-specific heading commands
	...
	\newcommand{\gwe@exam}[4]{%
		...
		{%
			...
			\addcontentsline{toc}{section}{\gwe@title}
			% Set the style for the title
			\sffamily\Huge\bfseries%
			% Each exam starts on its own page and is its own paragraph
			\clearpage%
			\hspace{-0.25in}\gwe@title\par%
			% Generate some space below the title
			\vspace*{0.75em}
		}%
	...
	\newcommand{\problem}[1]{%
		...
		{%
			...
			% Add the problem to the TOC
			\addcontentsline{toc}{subsection}{\gwe@title}
			% Set the style for the title and print it out
			...
			\else%
				\clearpage%
			\fi%
			\par\hspace{-0.125in}\gwe@title\par%
			...
			\label{prob:\gwe@examsymb\arabic{gwe@year}\Roman{gwe@part}\nn}
		}%
	}
